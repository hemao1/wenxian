...
<section class="content-container" id="wenxian">
	...
	<div class="content-first-banner">
		<img src="/wenxianchufang/wenxian2/Public/img/1_05.jpg">
		<img src="/wenxianchufang/wenxian2/Public/img/1_06.jpg">
		<img src="/wenxianchufang/wenxian2/Public/img/1_07.jpg">
	</div>
	<div class="about-us width1200">
		<img src="/wenxianchufang/wenxian2/Public/img/1_10.png">
		...
		<ul class="width1200 details-smal-list">
			<li>
				<img src="/wenxianchufang/wenxian2/Public/img/1_17.png">
				<p>选用天然食材，抒发着浓厚的家乡情怀，散发着低调大气的文化品位</p>
			</li>
			<li>
				<img src="/wenxianchufang/wenxian2/Public/img/1_14.png">
				<p>让游子回味乡愁，唤起儿时记忆，用心制作，打造高端会所</p>
			</li>
			<li>
				<img src="/wenxianchufang/wenxian2/Public/img/1_20.png">
	...
	<div class="classic-gourmet-container">
		<div class="classic-gourmet">
			<img src="/wenxianchufang/wenxian2/Public/img/1_45.png">
				...
				<div class="swiper-container" :class="{'swiper-container-hidden':isShow != 0}" id="swiper-1">
					<div class="swiper-wrapper">
						<div class="swiper-slide sweiper-img-box">
							<img class="sweiper-img" src="/wenxianchufang/wenxian2/Public/img/1.jpg" title="图片信息">
						</div>
						<div class="swiper-slide sweiper-img-box">
							<img class="sweiper-img" src="/wenxianchufang/wenxian2/Public/img/2.jpg" title="图片信息">
						</div>
						<div class="swiper-slide sweiper-img-box">
							<img class="sweiper-img" src="/wenxianchufang/wenxian2/Public/img/3.jpg" title="图片信息">
						</div>
						<div class="swiper-slide sweiper-img-box">
							<img class="sweiper-img" src="/wenxianchufang/wenxian2/Public/img/4.jpg" title="图片信息">
						</div>
						<div class="swiper-slide sweiper-img-box">
							<img class="sweiper-img" src="/wenxianchufang/wenxian2/Public/img/5.jpg" title="图片信息">
						</div>
					</div>
	...
	<div class="importantActivities-container width1200">
		...
		<ul class="width1200">
			<li>
				...
				<img src="/wenxianchufang/wenxian2/Public/img/0059.jpg">
			</li>
			<li>
				<div class="bg-layer">
					<p>合茂集团董事长与贝宁共和国大使会餐</p>
